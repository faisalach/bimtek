...
import { show, getData, add, edit, destroy } from '@/routes/assesment';
import { show as soal } from '@/routes/soal';
...
export default function Assesment() {
	...
	const menuLists = (data) => {
		const menus 	= [{
			label:"Soal Pre Test",
			url: soal(data.pretest_id).url
		},
		{
			label:"Soal Post Test",
			url: soal(data.posttest_id).url
		}];
		menus.push({
			label:"Edit",
